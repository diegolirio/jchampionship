        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="${pageContext.request.contextPath}"><i class="fa fa-fw fa-dashboard"></i> Classificação</a>
                    </li>
                    <li class="active">
                        <a href="#charts.html"><i class="fa fa-fw fa-bar-chart-o"></i> Jogos</a>
                    </li>
                    <li>
                        <a href="#tables.html"><i class="fa fa-fw fa-table"></i> Times</a>
                    </li>
                    <li>
                        <a href="#forms.html"><i class="fa fa-fw fa-edit"></i> Artilharia</a>
                    </li>
                    <!-- 
                    <li>
