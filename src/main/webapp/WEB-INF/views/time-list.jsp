        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-fw fa-table"></i> Times do Campeonato</h3>
                </div>
									...
									<tr>
										...
										<c:if test="${not empty usuario && not empty admin && admin}">
											<td>
												...
												&nbsp; | &nbsp; <small><a href="${pageContext.request.contextPath}/time/system/delete/${t.id}" id="idDeleteJogador"><span class="text-danger">excluir</span></a></small>
											</td>
										</c:if>
									</tr>
							</c:forEach>
