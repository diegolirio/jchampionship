    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <c:if test="${empty usuario}">
            	<li><a href="${pageContext.request.contextPath}/usuario/login?next=${requestScope['javax.servlet.forward.request_uri']}"><i class="fa fa-sign-out fa-fw"></i> Entrar</a></li>
            </c:if>
            <!-- /.dropdown -->
