...
<h1 class="page-header">Confirma novo Campeonato ?</h1>
...
<div class="row">
	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><i class="glyphicon glyphicon-ok text-success"></i> <a href="${pageContext.request.contextPath}/edicao/system/${edicao.id}/jogos">Jogos</a></li>
			<li class="active"><i class="glyphicon glyphicon-star text-warning"></i> Confirmação</li>
		</ol>
	</div>
</div>
<!-- /.row -->

	<h2 class="text-danger">${edicao.campeonato.descricao} ${edicao.descricao}</h2>
